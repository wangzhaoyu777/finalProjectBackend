...
//    @Value("${ucareer.jwt.reset-password-expire-in-hour}")
//    private Long passwordExpireHours;

//    @Value("${ucareer.jwt.reset-password-token}")
//    private String passwordPlainSecret;
